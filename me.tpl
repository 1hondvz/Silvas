    ...
    <ul id="hotcampaigns-habblet-list">
        ...
        <li class="even">
            <div class="hotcampaign-container">
                <a href="{{ site.sitePath }}/articles"><img src="{{ site.staticContentPath }}/c_images/hot_campaign_images_gb/frank_discord.gif" align="left" alt="" /></a>
                <h3>Under Construction</h3>
                <p>WAIT FOR DISCORD !</p>
        ...
        <li class="odd">
            <div class="hotcampaign-container">
                <a href="{{ site.sitePath }}/articles"><img src="{{ site.staticContentPath }}/c_images/banners/hot/uk_habboclub_160x70.gif" align="left" alt="" /></a>
                <h3>Join Our HC</h3>
                <p>HC Rank Gives its members access to exclusive items and special features in Silvas Egypt.</p>
                <p class="link"><a href="http://localhost/club">Go there &raquo;</a></p>
            </div>
        </li>
...
<div class="box-tabs-container clearfix">
    <h2>Silvas</h2>
    <ul class="box-tabs">
        <li id="tab-0-4-1"><a href="#">Search Silvas</a><span class="tab-spacer"></span></li>
...
<div class="habblet-content-info">
    <a name="habbo-search">Type in the first characters of the name to search for other {{ site.siteName }}.</a>
</div>
...
<script type="text/javascript">
	document.observe("dom:loaded", function() { NewsPromo.init(); });
					...
					<!-- <p><iframe src="{{ site.sitePath }}" height="280" allowtransparency="true" frameborder="0"></iframe></p> -->
					</div>
					<script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>
				<div class="habblet-container ">		
...
<div class="box-tabs-container clearfix">
    <h2>Tags</h2>
							...
							<ul class="box-tabs">
								<li id="tab-1-5-1"><a href="#">{{ site.siteName }} Like...</a><span class="tab-spacer"></span></li>
