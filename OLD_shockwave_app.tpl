			...
			<div class="habblet-container ">		
				<div class="cbb clearfix">
					...
					<div class="tutorial-text">							</h2>
						...
						<p> - <a href="http://localhost/classichabbo_exe.zip">Click here</a> to download (82 MB)</p>
						<p><b>Lite version:</b></p>
						<p>Contains no furniture. New furniture will be downloaded if the file doesn't exist.</p>
						<p> - <a href="http://localhost/classichabbo_exe_lite.zip">Click here</a> to download (25 MB)</p>
					</div>
				</div>
			</div>
		</div>
